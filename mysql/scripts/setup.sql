...
(
    ...
    job_website_link TEXT NOT NULL,
...
('Data Analyst', 'Collect and analyze data to inform business decisions', 'San Francisco', 55000.00, 75000.00, 1, 'https://en.wikipedia.org/wiki/Placeholder_name', 'https://en.wikipedia.org/wiki/Lorem_ipsum'),
('Sales Representative', 'Sell company products and services to potential customers', 'Houston', 45000.00, 65000.00, 1, 'https://en.wikipedia.org/wiki/Placeholder_name', 'https://en.wikipedia.org/wiki/Lorem_ipsum');
